...
async function main() {
    ...
    const MintNFTAddress = "0x79c976BC969B58622E0C924462442b6A1eD20C8f";
    const nrgyAddress = "0x14377ab79fDe67fA3A38a0cf89a83736013acdA6";
    const minterContract = await ethers.getContractFactory("Minter");
    const minter = await upgrades.deployProxy(minterContract, [managerAddress, MintNFTAddress, nrgyAddress], {
        kind: "uups"
    });
